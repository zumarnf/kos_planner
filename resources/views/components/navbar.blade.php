<nav class="bg-white-green" x-data="{ isOpen: false, isLoggedIn: false }">
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div x-show="isLoggedIn" class="relative ml-3">
                        <div>
                            <button type="button" @click="isOpen = !isOpen" class="relative flex max-w-xs items-center rounded-full bg-green-gd text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <div x-show="!isLoggedIn" class="space-x-4">
                        <a href="/login" class="text-gray-700 hover:text-white hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Login</a>
                        <a href="/register" class="text-gray-700 hover:text-white hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Register</a>
                    </div>
                </div>
            </div>
