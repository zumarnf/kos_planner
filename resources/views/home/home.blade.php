                ...
                <div class="w-60 h-80 bg-white-green my-8 mx-12 p-3 flex flex-col gap-1 rounded-2xl">
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex flex-row justify-between">
                            ...
                            <span class="font-bold text-red-600">{{ $dorm['price'] }}</span>
                        </div>
                        <a href="/detailpage/detail/{{ $dorm['slug'] }}" class="hover:bg-green-gd text-gray-50 bg-black-blue py-2 rounded-md text-center">Detail</a>
                    </div>
                </div>
            @endforeach
        </div>
