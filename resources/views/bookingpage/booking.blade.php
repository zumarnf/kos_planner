...
<body class="h-full flex flex-col">
    ...
    <div class="bg-lg-green w-512 mx-auto h-auto border-2 border-grey-gd rounded-xl p-8 m-4">
        <form action="{{ url('/bookingpage/booking/' . $rooms['slug']) }}" method="POST">
            @csrf
            <div class="flex flex-row">
                <div class="basis-1/2 flex flex-col justify-start">
                    <div class="mb-4">
                        ...
                        <input type="number" id="bulan" name="bulan" placeholder="Berapa bulan" class="w-full py-2 pl-4 pr-12 rounded-md outline-none ring-1 ring-grey-gh">
                    </div>
                    <div class="mb-4">
                        <label for="tanggal" class="block text-grey-gh font-medium mb-2">Tanggal Pemesanan</label>
                        <input type="date" id="tanggal" name="tanggal" placeholder="Tanggal Pemesanan" class="w-full py-2 pl-4 pr-12 rounded-md outline-none ring-1 ring-grey-gh">
                    </div>
                </div>
